...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-03-2022 a las 07:42:24
...
--
ALTER TABLE `cap_datos`
  MODIFY `id_datos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT de la tabla `carga_boleta`
--
ALTER TABLE `carga_boleta`
  MODIFY `id_carga` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;

--
-- AUTO_INCREMENT de la tabla `comanda`
--
ALTER TABLE `comanda`
  MODIFY `id_unico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=200;
