	...
	public Fr_MenuMesas() {
		...
		btn_aceptar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				numero = txt_displayNumeros.getText();
				display.setMesa(txt_displayNumeros.getText());
				/*
				if(txt_displayNumeros.getText().isEmpty()) {
					JOptionPane.showMessageDialog(null, "Debe Ingrear un numero");
					
				}else {
					display.setMesa(numero);
					setVisible(false);
				}
				*/
